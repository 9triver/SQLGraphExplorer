...
comment on column EAST51_YGB.jrxkzh
  is '金融许可证号';
comment on column EAST51_YGB.nbjgh
  is '内部机构号';
comment on column EAST51_YGB.yhjgmc
  is '银行机构名称';
comment on column EAST51_YGB.gh
  is '工号';
comment on column EAST51_YGB.xm
  is '姓名';
comment on column EAST51_YGB.gj
  is '国籍字段';
comment on column EAST51_YGB.zjlb
  is '个人证件类型';
comment on column EAST51_YGB.zjhm
  is '个人证件号码';
comment on column EAST51_YGB.lxdh
  is '联系电话';
comment on column EAST51_YGB.ssbm
  is '所属部门';
comment on column EAST51_YGB.gwbh
  is '岗位编号';
comment on column EAST51_YGB.gwmc
  is '岗位名称';
comment on column EAST51_YGB.sfgg
  is '是否高管';
comment on column EAST51_YGB.pfrq
  is '批复日期';
comment on column EAST51_YGB.rzrq
  is '任职日期';
comment on column EAST51_YGB.yglx
  is '员工类型';
comment on column EAST51_YGB.ygzt
  is '人员状态';
comment on column EAST51_YGB.bbz
  is '备注';
...
comment on column EAST51_YGB_GL.jgmc
  is '机构名称';
comment on column EAST51_YGB_GL.jgjc
  is '机构简称';
comment on column EAST51_YGB_GL.jgh
  is '机构号';
comment on column EAST51_YGB_GL.fzhmc
  is '分支行名称';
comment on column EAST51_YGB_GL.fzhjgh
  is '分支行机构号';
comment on column EAST51_YGB_GL.bm
  is '部门';
comment on column EAST51_YGB_GL.bmjgh
  is '部门机构号';
comment on column EAST51_YGB_GL.ygh
  is '员工号';
...
comment on column EAST5_JGXXB.yhjgdm
  is '银行机构代码';
comment on column EAST5_JGXXB.nbjgh
  is '内部机构号';
comment on column EAST5_JGXXB.jrxkzh
  is '金融许可证号';
comment on column EAST5_JGXXB.yyzzh
  is '营业执照号';
comment on column EAST5_JGXXB.yhjgmc
  is '银行机构名称';
comment on column EAST5_JGXXB.jglb
  is '机构类别';
comment on column EAST5_JGXXB.xzqhdm
  is '行政区划代码';
comment on column EAST5_JGXXB.yyzt
  is '营业状态';
comment on column EAST5_JGXXB.clrq
  is '成立日期';
comment on column EAST5_JGXXB.jgdz
  is '机构地址';
comment on column EAST5_JGXXB.jglxdh
  is '机构联系电话';
comment on column EAST5_JGXXB.fzrxm
  is '负责人姓名';
comment on column EAST5_JGXXB.fzrzw
  is '负责人职务';
comment on column EAST5_JGXXB.fzrlxdh
  is '负责人联系电话';
...
comment on column EAST5_YGB.jrxkzh
  is '金融许可证号';
comment on column EAST5_YGB.nbjgh
  is '内部机构号';
comment on column EAST5_YGB.yhjgmc
  is '银行机构名称';
comment on column EAST5_YGB.gh
  is '工号';
comment on column EAST5_YGB.xm
  is '姓名';
comment on column EAST5_YGB.gj
  is '国籍';
comment on column EAST5_YGB.zjlb
  is '证件类别';
comment on column EAST5_YGB.zjhm
  is '证件号码';
comment on column EAST5_YGB.lxdh
  is '联系电话';
comment on column EAST5_YGB.ssbm
  is '所属部门';
comment on column EAST5_YGB.gwbh
  is '岗位编号';
comment on column EAST5_YGB.gwmc
  is '岗位名称';
comment on column EAST5_YGB.sfgg
  is '是否高管';
comment on column EAST5_YGB.pfrq
  is '批复日期';
comment on column EAST5_YGB.rzrq
  is '任职日期';
comment on column EAST5_YGB.yglx
  is '员工类型';
comment on column EAST5_YGB.ygzt
  is '员工状态';
comment on column EAST5_YGB.bbz
  is '备注';
...
comment on column GZYH_CBJG_ZH.oldnbjgh
  is '老内部机构号';
...
insert into EAST51_YGB (jrxkzh, nbjgh, yhjgmc, gh, xm, gj, zjlb, zjhm, lxdh, ssbm, gwbh, gwmc, sfgg, pfrq, rzrq, yglx, ygzt, bbz, cjrq)
values (null, '0101', null, 'A002', '李四', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
insert into EAST51_YGB (jrxkzh, nbjgh, yhjgmc, gh, xm, gj, zjlb, zjhm, lxdh, ssbm, gwbh, gwmc, sfgg, pfrq, rzrq, yglx, ygzt, bbz, cjrq)
values (null, '0102', null, 'B001', '张龙', null, null, null, null, null, null, null, null, null, null, null, null, null, null);
insert into EAST51_YGB (jrxkzh, nbjgh, yhjgmc, gh, xm, gj, zjlb, zjhm, lxdh, ssbm, gwbh, gwmc, sfgg, pfrq, rzrq, yglx, ygzt, bbz, cjrq)
...
insert into EAST51_YGB_GL (jgmc, jgjc, jgh, fzhmc, fzhjgh, bm, bmjgh, ygh, cjrq)
values (null, null, null, null, null, null, 'BM001', 'A002', '20231031');
insert into EAST51_YGB_GL (jgmc, jgjc, jgh, fzhmc, fzhjgh, bm, bmjgh, ygh, cjrq)
values (null, null, null, null, null, null, 'BM002', 'B001', '20231031');
insert into EAST51_YGB_GL (jgmc, jgjc, jgh, fzhmc, fzhjgh, bm, bmjgh, ygh, cjrq)
...
insert into EAST5_JGXXB (yhjgdm, nbjgh, jrxkzh, yyzzh, yhjgmc, jglb, xzqhdm, yyzt, clrq, jgdz, jglxdh, fzrxm, fzrzw, fzrlxdh, cjrq)
values (null, 'BM002', null, null, null, null, null, null, null, null, null, null, null, null, '20231031');
insert into EAST5_JGXXB (yhjgdm, nbjgh, jrxkzh, yyzzh, yhjgmc, jglb, xzqhdm, yyzt, clrq, jgdz, jglxdh, fzrxm, fzrzw, fzrlxdh, cjrq)
